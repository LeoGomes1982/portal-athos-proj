...
import { Edit, Calendar, DollarSign, Clock, Award, Target, Brain, CheckCircle, FileText, HelpCircle } from "lucide-react";
                ...
                <CardContent className="p-4 relative">
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div className="absolute top-2 right-2 w-5 h-5 bg-gray-600 rounded-full flex items-center justify-center cursor-help animate-pulse">
                        <HelpCircle className="w-3 h-3 text-white" />
                      </div>
                    </TooltipTrigger>
                    <TooltipContent className="max-w-xs p-3">
                      <p className="text-sm">
                        Carência é o tempo em que um funcionário deve ter para poder avançar para este nível ou acessar esta vantagem ou situação na empresa.
                      </p>
                    </TooltipContent>
                  </Tooltip>
                </CardContent>
