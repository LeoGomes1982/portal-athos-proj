...
export function useFuncionarioSync() {
  ...
  const formatToDatabase = (funcionario: Funcionario) => ({
    ...
    data_admissao: funcionario.dataAdmissao || null,
    ...
    data_fim_experiencia: funcionario.dataFimExperiencia || null,
    data_fim_aviso_previo: funcionario.dataFimAvisoPrevio || null,
    ...
    data_inativacao: funcionario.dataInativacao || null,
